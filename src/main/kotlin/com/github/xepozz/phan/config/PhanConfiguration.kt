...
open class PhanConfiguration : QualityToolConfiguration() {
    ...
    @Transient
    override fun getToolPath() = myPhanPath
    ...
    @Attribute("tool_path")
    fun getSerializedToolPath(): String = serialize(myPhanPath).removeSuffix(".bat")
    ...
    override fun clone(): QualityToolConfiguration {
        val settings = PhanConfiguration()
        clone(settings)
        return settings
    }
