...
![Build](https://github.com/xepozz/phan-plugin/workflows/Build/badge.svg)
[![Version](https://img.shields.io/jetbrains/plugin/v/28754-phan-php.svg)](https://plugins.jetbrains.com/plugin/28754-phan-php)
[![Downloads](https://img.shields.io/jetbrains/plugin/d/28754-phan-php.svg)](https://plugins.jetbrains.com/plugin/28754-phan-php)

<!-- Plugin description -->

[Github](https://github.com/j-plugins/phan-plugin) | [Donation](https://github.com/xepozz/xepozz?tab=readme-ov-file#become-a-sponsor)
...
- Using the IDE built-in plugin system:
  ...
  <kbd>Settings/Preferences</kbd> > <kbd>Plugins</kbd> > <kbd>Marketplace</kbd> > <kbd>Search for "phan-plugin"</kbd> >
  <kbd>Install</kbd>
  
- Using JetBrains Marketplace:

  Go to [JetBrains Marketplace](https://plugins.jetbrains.com/plugin/28754-phan-php) and install it by clicking the <kbd>Install to ...</kbd> button in case your IDE is running.

  You can also download the [latest release](https://plugins.jetbrains.com/plugin/28754-phan-php/versions) from JetBrains Marketplace and install it manually using
  <kbd>Settings/Preferences</kbd> > <kbd>Plugins</kbd> > <kbd>⚙️</kbd> > <kbd>Install plugin from disk...</kbd>

- Manually:

  Download the [latest release](https://github.com/xepozz/phan-plugin/releases/latest) and install it manually using
  <kbd>Settings/Preferences</kbd> > <kbd>Plugins</kbd> > <kbd>⚙️</kbd> > <kbd>Install plugin from disk...</kbd>
